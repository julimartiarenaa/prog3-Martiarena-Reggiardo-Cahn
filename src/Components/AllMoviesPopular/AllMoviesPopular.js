...
import "./AllMoviesPopular.css"
import MovieElement from "../MovieElement/MovieElement";

class AllMoviesPopular extends Component {
    constructor(props) {
        super(props);
        this.state = {
            movies: [],
    ...
    componentDidMount() {
        fetch(`https://api.themoviedb.org/3/movie/popular?api_key=7bbfa155b881d065cf760bebe36c4d28&page=1`)
    ...
    cargasMas() {
        ...
        fetch(`https://api.themoviedb.org/3/movie/popular?api_key=7bbfa155b881d065cf760bebe36c4d28&page=${this.state.numPage}`)
        .then(response => response.json())    
        .then(data => {
                this.setState({
        ...
        return (
            <React.Fragment>
                <article className="moviesList">
                    ...
                    <h1 className="title"> Todas las peliculas de populares</h1>
...
export default AllMoviesPopular